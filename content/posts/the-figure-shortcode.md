...
This theme extends upon default figure shortcode to implement following features :

* Convert JPG Images on the fly to WEBP and serve WEBP images with JPG as a fallback.
