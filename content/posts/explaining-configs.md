...
- `[params]`
	...
	- `themeColor`: Populates theme-color meta and various elements of the site. If not present, it will use declarations in **/themes/hermit-V2/assets/scss/_colors.scss**.
